...
app = MeshPagesServer(
    ...
    courtousy_interval=3.0,  # Delay between sending consecutive chunks (in seconds). Default 2.5 seconds in order for any Meshtastic apps to be able to process all the chunks coming in.
    timeout=60,  # Maximum time to wait before dropping a client request (in seconds). Default 60 seconds.
